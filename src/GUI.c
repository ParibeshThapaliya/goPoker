...
const char *RedBox = "../lib/table/redbox.png";
const char *GreenBox = "../lib/table/greenbox.png";
...
GtkWidget* create_main_window(void) {
    ...
    TableTop = gtk_image_new_from_file("../lib/table/topleft.png");
    ...
    TableBot = gtk_image_new_from_file("../lib/table/botleft.png");
    ...
    TableLeft = gtk_image_new_from_file("../lib/table/leftside.png");
    ...
    TableRight = gtk_image_new_from_file("../lib/table/rightside.png");
    ...
    // Inner
    TopRightFourTwo = gtk_image_new_from_file("../lib/table/2by4square.png");
    gtk_widget_set_size_request((GtkWidget *)TopRightFourTwo, 100, 200);
    BotRightFourTwo = gtk_image_new_from_file("../lib/table/2by4square.png");
    gtk_widget_set_size_request((GtkWidget *)BotRightFourTwo, 100, 200);
    TopLeftFourTwo = gtk_image_new_from_file("../lib/table/2by4square.png");
    gtk_widget_set_size_request((GtkWidget *)TopLeftFourTwo, 100, 200);
    BotLeftFourTwo = gtk_image_new_from_file("../lib/table/2by4square.png");
    gtk_widget_set_size_request((GtkWidget *)BotLeftFourTwo, 100, 200);
    TopLeftTwoTwo = gtk_image_new_from_file("../lib/table/2by2square.png");
    gtk_widget_set_size_request((GtkWidget *)TopLeftTwoTwo, 100, 100);
    TopRightTwoTwo = gtk_image_new_from_file("../lib/table/2by2square.png");
    gtk_widget_set_size_request((GtkWidget *)TopRightTwoTwo, 100, 100);
    TopMiddle1 = gtk_image_new_from_file("../lib/table/2by2square.png");
    gtk_widget_set_size_request((GtkWidget *)TopMiddle1, 100, 100);
    TopMiddle2 = gtk_image_new_from_file("../lib/table/1by2square.png");
    gtk_widget_set_size_request((GtkWidget *)TopMiddle2, 50, 100);
    BotLeftTwoTwo = gtk_image_new_from_file("../lib/table/2by2square.png");
    gtk_widget_set_size_request((GtkWidget *)BotLeftTwoTwo, 100, 100);
    BotRightTwoTwo = gtk_image_new_from_file("../lib/table/2by2square.png");
    gtk_widget_set_size_request((GtkWidget *)BotRightTwoTwo, 100, 100);
    BotMiddle1 = gtk_image_new_from_file("../lib/table/2by2square.png");
    gtk_widget_set_size_request((GtkWidget *)BotMiddle1, 100, 100);
    BotMiddle2 = gtk_image_new_from_file("../lib/table/1by2square.png");
    ...
    // Middle for cards
    MiniTop = gtk_image_new_from_file("../lib/table/5by1square.png");
    MiniBot = gtk_image_new_from_file("../lib/table/5by1square.png");
    MiniLeft = gtk_image_new_from_file("../lib/table/1by4square.png");
    MiniRight = gtk_image_new_from_file("../lib/table/1by4square.png");
    Middle1 = gtk_image_new_from_file("../lib/table/2by2square.png");
    Middle2 = gtk_image_new_from_file("../lib/table/2by2square.png");
    Middle3 = gtk_image_new_from_file("../lib/table/1by2square.png");
